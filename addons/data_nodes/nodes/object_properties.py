...
class ObjectPropertiesNode(Node):
    ...
    locationProperty = bpy.props.FloatVectorProperty(
        name='Location', default=(0.0, 0.0, 0.0), update=update_object_location)
    rotationProperty = bpy.props.FloatVectorProperty(
        name='Rotation', default = (0.0, 0.0, 0.0), update=update_object_rotation)
    scaleProperty = bpy.props.FloatVectorProperty(
        name='Scale', default = (1.0, 1.0, 1.0), update=update_object_scale)
    invertMatrixProperty = bpy.props.BoolProperty(
        name='Invert Matrix', default = False, update=update_invert_matrix)
